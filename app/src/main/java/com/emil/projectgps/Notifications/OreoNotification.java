package com.emil.projectgps.Notifications;
...
public class OreoNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_NAME = "Psudo Maps";
    ...
    public Notification.Builder getOreoNotification(String title, String body, PendingIntent pendingIntent, Uri soundUri, String icon)
    {
        return new Notification.Builder(getApplicationContext(), CHANNEL_ID).setContentIntent(pendingIntent)
                .setContentTitle(title).setContentText(body).setSmallIcon(Integer.parseInt(icon))
